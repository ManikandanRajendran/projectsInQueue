...
var Jd=[C.B,C.J],Kd=function(a){var b=a[C.Od];b&&D(40);var c=a[C.Pd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Od&&f!==C.Pd)if(-1<Ha(Jd,f)){var h=f,k=a[f],l=d[e];ud().set(h,k,l,"GB","GB-ENG",c)}else{}},Ld=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
